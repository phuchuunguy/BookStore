  ...
  return (
    ...
    <Container className={styles.container}>
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        ...
        <p>
          Wabooks phục vụ giao hàng cho khách hàng phạm vi&nbsp;
        ...
        <p>
          Từ ngày 01/05/2018, phí ưu đãi giao hàng&nbsp;
          <strong>toàn quốc đồng giá 25.000 vnđ</strong> với tất cả các đơn hàng.
        </p>
        <p className="pl-4 italic text-sm text-gray-600">
          (*) Miễn phí vận chuyển với các đơn hàng mua các sản phẩm sách Combo đặc biệt, và nằm trong chương trình miễn phí vận chuyển của Wabooks.
        </p>
